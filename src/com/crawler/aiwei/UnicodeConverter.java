...
public class UnicodeConverter {
    ...
    /**
     * 将字符串编码成 Unicode 形式的字符串. 如 "黄" to "\u9EC4" Converts unicodes to encoded \\uxxxx and escapes special characters with a preceding slash
     * 
    ...
    /**
     * 从 Unicode 形式的字符串转换成对应的编码的特殊字符串。 如 "\u9EC4" to "黄". Converts encoded \\uxxxx to unicode chars and changes special saved chars to their original forms
     * 
